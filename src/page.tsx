...
// Routing parameters we are expecting.
interface IRouteParams {
    id?: string;
}

// IOwnProps type to receive routing props as well as passed in component props 
...
// using the object short hand for map dispatch to props. No need to call bindActionCreators manually
// https://react-redux.js.org/using-react-redux/connect-mapdispatch#defining-mapdispatchtoprops-as-an-object
const mapDispatch = {
    increaseClickCount
};

// Interring the connected prop type automatically 
